...
function useControlledSwitchWarning(
  ...
  React.useEffect(() => {
    ...
    warning(
      !(!isControlled && wasControlled),
      `\`${componentName}\` is changing from controlled to be uncontrolled. Components should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled \`${componentName}\` for the lifetime of the component. Check the \`on\` prop.`,
    )
...
function useOnChangeReadOnlyWarning(
  ...
  React.useEffect(() => {
    warning(
      !(!onChangeProvided && isControlled && !readOnly),
...
function useToggle({
  ...
  const onChangeProvided = Boolean(onChange) 
